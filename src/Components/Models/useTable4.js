...
import {  deleteAllFaqs, deleteAllSuccessStories, deleteAllWhyService } from "../../DAL/delete";
import { useAlert } from "../Alert/AlertContext";
import DeleteModal from "./confirmDeleteModel";
import { useParams } from "react-router-dom";
import FaqsModel from "./faqsModel";
import WhyServiceModel from "./whyServiceModel";

export function useTable4({ attributes4, tableType, data }) {
  ...
  const handleDelete = async () => {
    ...
    try {
      let response = await deleteAllWhyService({ ids: selected });
  ...
  return {
    tableUI4: (
      <>
        ...
        <Box sx={{ width: "100%" }}>
          <Paper sx={{ width: "100%", maxHeight: "95vh", boxShadow: "none",marginBottom:'50px' }}>
